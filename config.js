...
global.botNumberCode = "+5511978441497" //example: "+59309090909"
...
["5511978441497", 'Raiden Shogun', 1], 
["558381844965", 'Picapou', 1],  
["5511997466747", 'Elber', 1]]

global.mail = 'theelber7@gmail.com' // Add email
...
global.country = 'BR' // Add country, example: 🇪🇨
// • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •

global.packname = `╭ *_Raiden Shogun-MD_* \n┃\n┃ » 𝚃𝚎𝚕𝚎𝚐𝚛𝚊𝚖:\n┃ @globalgb\n┃\n┃ » 𝚈𝚘𝚞𝚃𝚞𝚋𝚎:\n┃ @gatadios\n┃\n┃ » 𝙸𝚗𝚜𝚝𝚊𝚐𝚛𝚊𝚖:\n┃ @gata_dios\n╰━━━━━━━━•` //"𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿 🐈"
global.author = ` ╭ *TheElber7*\n ┃\n ┃ » 𝙶𝚒𝚝𝙷𝚞𝚋:\n ┃ TheElber7\n ┃\n ┃ ⊹ Bot para grupos de WhatsApp.\n ┃\n ┃ ♡ Apoio\n ┃ » 𝙿𝚊𝚢𝙿𝚊𝚕:\n ┃ \n ╰━━━━━━━━•` //"𝙂𝙖𝙩𝙖 𝘿𝙞𝙤𝙨"
...
global.rg = '╰⊱✅⊱ *_RESULTADO | RESULT_* ⊱✅⊱╮\n\n'
global.resultado = rg

global.ag = '╰⊱⚠️⊱ *_AVISO | WARNING_* ⊱⚠️⊱╮\n\n'
global.advertencia = ag

global.iig = '╰⊱❕⊱ *_INFORMAÇÃO | INFORMATION_* ⊱⊱╮\n\n'
global.informacion = iig

global.fg = '╰⊱❌⊱ *_FALHA | ERROR_* ⊱❌⊱╮\n\n'
global.fallo = fg

global.mg = '╰⊱❗️⊱ *_USO INCORRETO | USED IT WRONG_* ⊱❗️⊱╮\n\n'
global.mal = mg

global.eeg = '╰⊱📩⊱ *_REPORTAR | REPORT_* ⊱📩⊱╮\n\n'
global.envio = eeg

global.eg = '╰⊱💚⊱ *_SUCESSO | SUCCESS_* ⊱💚⊱╮\n\n'
global.exito = eg

// • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • • •
global.wm = "ℝ𝕒𝕚𝕕𝕖𝕟 𝕊𝕙𝕠𝕘𝕦𝕟-𝕄𝔻 : TheElber7"
...
global.bottime = `*HORA* : ${moment.tz('America/Los_Angeles').format('HH:mm:ss')}`;//America/Los_Angeles
global.fgif = {
key: {
...
const response = await fetch('https://raw.githubusercontent.com/TheElber7/RaidenShogun-MD/master/official_accounts.json')
