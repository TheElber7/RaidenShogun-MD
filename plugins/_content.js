...
global.canales = [canal1].getRandom()
global.welgata = [asistencia].getRandom()
global.redesMenu = [canal1, soporteGB, grupo1, grupo2, grupo3, grupo4, grupo5, grupo6, md, asistencia].getRandom()
global.accountsgb = [canal1, md, asistencia].getRandom()
